# Copied from backend/compact-connect/lambdas/python/data-events/handlers/home_jurisdiction_events.py

from uuid import UUID

from common_lambdas.config import config, logger
from common_lambdas.data_model.schema.data_event.api import HomeJurisdictionChangeEventDetailSchema
