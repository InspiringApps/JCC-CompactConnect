# Copied from backend/cosmetology-app/lambdas/python/data-events/handlers/data_events.py

from datetime import UTC, datetime

from common_lambdas.config import config, logger
from common_lambdas.data_model.schema.license.ingest import SanitizedLicenseIngestDataEventSchema
