# Copied from backend/cosmetology-app/lambdas/python/data-events/handlers/investigation_events.py

from typing import Any, Protocol
from uuid import UUID

from common_lambdas.config import config, logger
from common_lambdas.data_model.schema.data_event.api import InvestigationEventDetailSchema
...
from common_lambdas.utils import sqs_handler
