# Copied from backend/cosmetology-app/lambdas/python/data-events/handlers/encumbrance_events.py

from uuid import UUID

from common_lambdas.config import config, logger
from common_lambdas.data_model.provider_record_util import ProviderData, ProviderUserRecords
from common_lambdas.data_model.schema.common import LicenseEncumberedStatusEnum
from common_lambdas.data_model.schema.data_event.api import (
    EncumbranceEventDetailSchema,
)
from common_lambdas.email_service_client import (
...
from common_lambdas.utils import sqs_handler_with_notification_tracking
