# Copied from backend/cosmetology-app/lambdas/python/data-events/tests/function/test_investigation_events.py
...
class TestInvestigationEvents(TstFunction):
    ...
    @patch('common_lambdas.email_service_client.EmailServiceClient.send_license_investigation_state_notification_email')
    def test_license_investigation_listener_processes_event_with_provider(self, mock_state_email):
        ...
        from common_lambdas.email_service_client import InvestigationNotificationTemplateVariables
    ...
    @patch(
        'common_lambdas.email_service_client.EmailServiceClient.send_license_investigation_closed_state_notification_email'
    )
    ...
    @patch('common_lambdas.email_service_client.EmailServiceClient.send_privilege_investigation_state_notification_email')
    ...
    @patch(
        'common_lambdas.email_service_client.EmailServiceClient.send_privilege_investigation_closed_state_notification_email'
    )
