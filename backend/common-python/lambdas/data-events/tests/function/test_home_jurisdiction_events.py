# Copied from backend/compact-connect/lambdas/python/data-events/tests/function/test_home_jurisdiction_events.py
...
class TestHomeJurisdictionChangeEvents(TstFunction):
    ...
    @patch('common_lambdas.email_service_client.EmailServiceClient.send_home_jurisdiction_change_old_state_notification')
    @patch('common_lambdas.email_service_client.EmailServiceClient.send_home_jurisdiction_change_new_state_notification')
    ...
    def test_no_old_state_notification_when_previous_is_other(self, mock_send_new_state, mock_send_old_state):
        ...
        from common_lambdas.data_model.schema.fields import OTHER_JURISDICTION
        from handlers.home_jurisdiction_events import home_jurisdiction_change_notification_listener
