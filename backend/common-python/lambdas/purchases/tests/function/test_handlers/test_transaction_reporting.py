# Copied from backend/compact-connect/lambdas/python/purchases/tests/function/test_handlers/test_transaction_reporting.py
...
class TestGenerateTransactionReports(TstFunction):
    ...
    @patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat('2025-04-05T22:00:00+00:00'))
    ...
    @patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat('2024-03-01T00:05:00+00:00'))
    @patch('handlers.transaction_reporting.config.email_service_client')
    ...
    # event bridge triggers the weekly report at Friday 10:00 PM UTC (5:00 PM EST)
    @patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat('2025-03-08T22:00:01+00:00'))
    @patch('handlers.transaction_reporting.config.email_service_client')
