# Copied from backend/compact-connect/lambdas/python/purchases/tests/function/test_handlers/test_transaction_history.py
...
class TestProcessSettledTransactions(TstFunction):
    ...
    @patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat('2024-01-01T12:00:00+00:00'))
