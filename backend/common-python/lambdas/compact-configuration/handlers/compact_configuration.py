# Copied from backend/cosmetology-app/lambdas/python/compact-configuration/handlers/compact_configuration.py
...
from common_lambdas.data_model.schema.compact.api import (
...
from common_lambdas.data_model.schema.jurisdiction.api import (
...
from common_lambdas.exceptions import CCInvalidRequestException, CCNotFoundException
from common_lambdas.utils import api_handler, authorize_compact_level_only_action, authorize_state_level_only_action
