# Copied from backend/cosmetology-app/lambdas/python/provider-data-v1/tests/function/test_data_model/test_provider_transformations.py
...
class TestTransformations(TstFunction):
    ...
    @patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat(MOCK_CURRENT_DATETIME_STRING))
    @patch('common_lambdas.config._Config.license_preprocessing_queue')
