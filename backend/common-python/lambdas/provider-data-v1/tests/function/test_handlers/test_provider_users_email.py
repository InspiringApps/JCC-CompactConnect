# Copied from backend/compact-connect/lambdas/python/provider-data-v1/tests/function/test_handlers/test_provider_users_email.py
...
@mock_aws
@patch('common_lambdas.config._Config.current_standard_datetime', MOCK_CURRENT_TIME)
class TestPatchProviderUsersEmail(TstFunction):
    ...
    @patch('common_lambdas.config._Config.email_service_client')
