# Copied from backend/compact-connect/lambdas/python/provider-data-v1/tests/function/test_handlers/test_provider_users_home_jurisdiction_change.py
...
@mock_aws
@patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat('2024-11-08T23:59:59+00:00'))
class TestPutProviderHomeJurisdiction(TstFunction):
    ...
    def _when_provider_has_one_license_and_privilege(
        ...
        from common_lambdas.data_model.schema.common import LicenseEncumberedStatusEnum, PrivilegeEncumberedStatusEnum
    ...
    def _when_provider_has_license_in_new_home_state(
        ...
        from common_lambdas.data_model.schema.common import LicenseEncumberedStatusEnum
    ...
    @patch('common_lambdas.event_bus_client.EventBusClient.publish_home_jurisdiction_change_event')
    ...
    def test_put_provider_home_jurisdiction_deactivates_privileges_if_no_license_in_new_jurisdiction(self):
        from common_lambdas.data_model.schema.privilege import PrivilegeData
        from handlers.provider_users import provider_users_api_handler
    ...
    def test_put_provider_home_jurisdiction_adds_provider_update_record_when_valid_member_jurisdiction(self):
        from common_lambdas.data_model.schema.provider import ProviderUpdateData
        from handlers.provider_users import provider_users_api_handler
