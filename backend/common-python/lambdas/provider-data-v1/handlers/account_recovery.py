# Copied from backend/compact-connect/lambdas/python/provider-data-v1/handlers/account_recovery.py
...
from common_lambdas.config import config, logger, metrics
...
from common_lambdas.utils import api_handler, delayed_function, hash_password, verify_password, verify_recaptcha
