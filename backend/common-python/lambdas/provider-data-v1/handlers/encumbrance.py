# Copied from backend/cosmetology-app/lambdas/python/provider-data-v1/handlers/encumbrance.py
...
from common_lambdas.data_model.schema.adverse_action.api import (
