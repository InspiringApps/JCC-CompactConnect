# Copied from backend/cosmetology-app/lambdas/python/provider-data-v1/handlers/investigation.py
...
from common_lambdas.data_model.schema.investigation.api import (
...
from common_lambdas.utils import api_handler, authorize_state_level_only_action, to_uuid
