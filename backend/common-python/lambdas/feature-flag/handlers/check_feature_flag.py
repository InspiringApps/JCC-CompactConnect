# Copied from backend/cosmetology-app/lambdas/python/feature-flag/handlers/check_feature_flag.py

import json

from aws_lambda_powertools.utilities.typing import LambdaContext
from common_lambdas.config import config, logger
from common_lambdas.exceptions import CCInternalException, CCInvalidRequestException
