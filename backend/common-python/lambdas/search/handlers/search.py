# Copied from backend/cosmetology-app/lambdas/python/search/handlers/search.py
...
from common_lambdas.data_model.schema.provider.api import (
    ProviderGeneralResponseSchema,
    SearchProvidersRequestSchema,
)
from common_lambdas.exceptions import CCInvalidRequestException
from common_lambdas.utils import api_handler, authorize_compact_level_only_action, get_event_scopes
