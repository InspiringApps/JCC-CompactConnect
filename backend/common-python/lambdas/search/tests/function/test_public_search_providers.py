# Copied from backend/cosmetology-app/lambdas/python/search/tests/function/test_public_search_providers.py
...
class TestPublicSearchProviders(TstFunction):
    ...
    def _ingest_style_sanitize_opensearch_source(self, source: dict) -> dict:
        ...
        """
        from common_lambdas.data_model.schema.provider.api import ProviderOpenSearchDocumentSchema
    ...
    @patch('handlers.public_search.opensearch_client')
    @patch('common_lambdas.config._Config.expiration_resolution_date', date(2030, 1, 1))
