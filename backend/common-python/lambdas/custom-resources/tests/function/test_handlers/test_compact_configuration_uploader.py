# Copied from backend/cosmetology-app/lambdas/python/custom-resources/tests/function/test_handlers/test_compact_configuration_uploader.py
...
@mock_aws
@patch('common_lambdas.config._Config.current_standard_datetime', datetime.fromisoformat(MOCK_CURRENT_TIMESTAMP))
