# Copied from backend/cosmetology-app/lambdas/python/staff-users/tests/function/__init__.py
...
class TstFunction(TstLambdas):
    ...
    def _create_compact_board_user(self, compact: str, jurisdiction: str):
        ...
        from common_lambdas.data_model.schema.user.record import UserRecordSchema
