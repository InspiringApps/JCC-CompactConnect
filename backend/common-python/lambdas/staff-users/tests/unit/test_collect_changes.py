# Copied from backend/cosmetology-app/lambdas/python/staff-users/tests/unit/test_collect_changes.py
...
class TestCollectChanges(TstLambdas):
    ...
    def test_compact_changes(self):
        from common_lambdas.utils import collect_and_authorize_changes
    ...
    @patch('common_lambdas.utils.config.compact_configuration_client')
