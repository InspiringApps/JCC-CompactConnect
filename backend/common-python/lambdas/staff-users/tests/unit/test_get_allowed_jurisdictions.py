# Copied from backend/cosmetology-app/lambdas/python/staff-users/tests/unit/test_get_allowed_jurisdictions.py
...
class TestGetAllowedJurisdictions(TstLambdas):
    ...
    def test_board_admin(self):
        from common_lambdas.utils import get_allowed_jurisdictions
