# Copied from backend/cosmetology-app/lambdas/python/staff-users/handlers/me.py

import json

from aws_lambda_powertools.utilities.typing import LambdaContext
from common_lambdas.config import config, logger
from common_lambdas.data_model.schema.user.api import UserMergedResponseSchema
