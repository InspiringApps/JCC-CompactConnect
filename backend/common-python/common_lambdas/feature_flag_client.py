# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/feature_flag_client.py
...
from common_lambdas.feature_flag_enum import FeatureFlagEnum
