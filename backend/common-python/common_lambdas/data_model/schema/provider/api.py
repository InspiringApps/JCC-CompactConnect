# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/provider/api.py
...
from common_lambdas.data_model.schema.common import CCRequestSchema
