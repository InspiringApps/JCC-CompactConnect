# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/provider/__init__.py
...
from common_lambdas.data_model.schema.provider.record import (
