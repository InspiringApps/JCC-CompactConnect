# Copied from backend/compact-connect/lambdas/python/common/cc_common/data_model/schema/provider/__init__.py
...
from common_lambdas.data_model.schema.provider.jcc_provider_record import (
