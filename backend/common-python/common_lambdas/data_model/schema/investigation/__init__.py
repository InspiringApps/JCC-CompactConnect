# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/investigation/__init__.py
...
from common_lambdas.data_model.schema.investigation.record import InvestigationRecordSchema
