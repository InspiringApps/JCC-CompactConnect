# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/investigation/record.py
...
from common_lambdas.data_model.schema.common import ValidatesLicenseTypeMixin
