# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/investigation/api.py

# ruff: noqa: N801, N815  invalid-name
from marshmallow.fields import Nested, Raw, String
from marshmallow.validate import OneOf

from common_lambdas.data_model.schema.adverse_action.api import AdverseActionPostRequestSchema
