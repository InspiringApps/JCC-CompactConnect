# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/adverse_action/__init__.py

# ruff: noqa: N802 we use camelCase to match the marshmallow schema definition
from datetime import date, datetime
from uuid import UUID

from common_lambdas.data_model.schema.adverse_action.record import AdverseActionRecordSchema
