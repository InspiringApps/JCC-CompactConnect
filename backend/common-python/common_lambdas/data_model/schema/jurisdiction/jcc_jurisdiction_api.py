# Copied from backend/compact-connect/lambdas/python/common/cc_common/data_model/schema/jurisdiction/api.py
...
from common_lambdas.data_model.schema.fields import PositiveDecimal
