# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/compact/record.py
...
from common_lambdas.data_model.schema.compact.common import (
    COMPACT_TYPE,
