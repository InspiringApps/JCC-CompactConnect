# Copied from backend/compact-connect/lambdas/python/common/cc_common/data_model/schema/compact/__init__.py
...
from common_lambdas.data_model.schema.compact.common import CompactFeeType, TransactionFeeChargeType
