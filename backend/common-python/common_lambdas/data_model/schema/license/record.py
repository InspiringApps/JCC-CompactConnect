# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/schema/license/record.py
...
from common_lambdas.data_model.schema.base_record import (
    BaseRecordSchema,
    ForgivingSchema,
)
...
from common_lambdas.data_model.schema.investigation.record import InvestigationDetailsSchema
from common_lambdas.data_model.schema.license.common import LicenseCommonSchema
