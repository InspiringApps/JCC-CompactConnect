# Copied from backend/compact-connect/lambdas/python/common/cc_common/data_model/schema/transaction/__init__.py
...
from common_lambdas.data_model.schema.transaction.record import TransactionRecordSchema
