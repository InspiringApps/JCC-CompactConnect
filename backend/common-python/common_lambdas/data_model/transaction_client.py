# Copied from backend/compact-connect/lambdas/python/common/cc_common/data_model/transaction_client.py
...
from common_lambdas.data_model.schema.transaction.record import UnsettledTransactionRecordSchema
