# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/query_paginator.py
...
from common_lambdas.utils import load_records_into_schemas
