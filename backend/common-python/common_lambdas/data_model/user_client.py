# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/user_client.py
...
from common_lambdas.data_model.schema.common import StaffUserStatus
from common_lambdas.data_model.schema.user.record import (
    CompactPermissionsRecordSchema,
    UserAttributesRecordSchema,
    UserRecordSchema,
)
from common_lambdas.exceptions import CCInternalException, CCInvalidRequestException, CCNotFoundException
from common_lambdas.utils import get_sub_from_user_attributes
