# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/provider_record_util.py
...
from common_lambdas.data_model.schema.provider import ProviderData, ProviderUpdateData
from common_lambdas.data_model.schema.provider.record import PROVIDER_AGGREGATE_FIELDS
