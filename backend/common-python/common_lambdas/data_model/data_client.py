# Copied from backend/cosmetology-app/lambdas/python/common/cc_common/data_model/data_client.py
...
from common_lambdas.config import _Config, config, logger
from common_lambdas.data_model.provider_record_util import (
    ProviderRecordType,
    ProviderUserRecords,
)
from common_lambdas.data_model.query_paginator import paginated_query
from common_lambdas.data_model.schema.adverse_action import AdverseActionData
from common_lambdas.data_model.schema.base_record import SSNIndexRecordSchema
...
from common_lambdas.license_util import LicenseUtility
