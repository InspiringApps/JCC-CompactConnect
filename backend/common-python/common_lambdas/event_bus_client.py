# Copied from backend/compact-connect/lambdas/python/common/cc_common/event_bus_client.py
...
from common_lambdas.data_model.schema.common import InvestigationAgainstEnum
...
from common_lambdas.event_batch_writer import EventBatchWriter
