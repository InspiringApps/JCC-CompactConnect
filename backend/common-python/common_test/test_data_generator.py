# Copied from backend/cosmetology-app/lambdas/python/common/common_test/test_data_generator.py
...
from common_lambdas.data_model.schema.adverse_action import AdverseActionData
from common_lambdas.data_model.schema.common import CCDataClass
from common_lambdas.data_model.schema.compact import CompactConfigurationData
from common_lambdas.data_model.schema.investigation import InvestigationData
from common_lambdas.data_model.schema.jurisdiction import JurisdictionConfigurationData
from common_lambdas.data_model.schema.license import LicenseData, LicenseUpdateData
from common_lambdas.data_model.schema.provider import ProviderData
from common_lambdas.utils import ResponseEncoder
...
class TestDataGenerator:
    ...
    def put_compact_active_member_jurisdictions(
        ...
        """
        from common_lambdas.config import config
        from common_lambdas.data_model.compact_configuration_utils import CompactConfigUtility
