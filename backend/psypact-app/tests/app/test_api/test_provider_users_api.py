...
class TestProviderUsersApi(TestApi):
    ...
    def test_synth_does_not_wire_provider_registration(self):
        v1_api = self.app.sandbox_backend_stage.api_stack.api.v1_api
        self.assertFalse(hasattr(v1_api.provider_users, 'provider_users_registration_resource'))
        self.assertFalse(hasattr(self.app.sandbox_backend_stage.api_lambda_stack.provider_users_lambdas, 'provider_registration_handler'))
    ...
    def test_synth_does_not_wire_military_affiliation(self):
        v1_api = self.app.sandbox_backend_stage.api_stack.api.v1_api
        self.assertFalse(hasattr(v1_api.provider_users, 'provider_users_me_military_affiliation_resource'))
    ...
    def test_synth_generates_provider_users_me_home_jurisdiction_endpoint_resource(self):
        ...
        api_lambda_stack_template.has_resource_properties(
            type=CfnFunction.CFN_RESOURCE_TYPE_NAME,
            props={'Handler': 'handlers.psypact_home_jurisdiction.put_psypact_provider_home_jurisdiction'},
        )
        ...
        api_stack_template.has_resource_properties(
            ...
            props={
                ...
                'Integration': TestApi.generate_expected_integration_object_for_imported_lambda(
                    api_lambda_stack,
                    api_lambda_stack_template,
                    api_lambda_stack.provider_users_lambdas.provider_home_jurisdiction_handler,
                ),
                'RequestModels': {
